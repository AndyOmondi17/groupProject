...
<body>
    ...
    <div class="container">
        ...
        <!-- This is where your PHP script will generate the list of articles -->
        <?php
            include "Handlers/db_connect.php";

            $query = "SELECT * FROM articles ORDER BY publicationDate DESC LIMIT 4";
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo '<p class="card-text">' . $row["fullText"] . '</p>';
                    echo '</div>';
                    echo '<div class="card-footer text-muted">';
                    echo 'Posted on ' . $row["publicationDate"] . ' by ' . $row["authorFullName"];
                    echo '</div></div>';
                }
            } else {
                echo '<div class="card mb-4">';
                echo '<div class="card-body">';
                echo '<h5 class="card-title">Dummy Article Title</h5>';
                echo '<p class="card-text">This is a placeholder for an article. Once articles are added, they will appear here.</p>';
                echo '</div>';
                echo '<div class="card-footer text-muted">';
                echo 'Posted on N/A by Anonymous';
                echo '</div></div>';
            }
        ?>
        <!-- Comment section -->
            ...
            <div class="card-body">
                <form method="POST" action="processes/submit_article.php"> <!-- Update this with your form submission handler -->
                    <div class="form-group">
                        <label for="authorFullName">Author's Full Name</label>
                        <input type="text" class="form-control" id="authorFullName" name="authorFullName" placeholder="Enter your full name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="fullText">Article Full Text</label>
                        <textarea class="form-control" id="fullText" name="fullText" rows="3" placeholder="Enter the full text of the article"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" name="viewblog" class="btn btn-primary">Submit</button>
                </form>
            </div>
        </div>
        ...
        <div class="media mb-4">
            <img class="d-flex mr-3 rounded-circle" src="user.jpg" alt="">
            <div class="media-body">
                <h5 class="mt-0">User Name</h5>
                <p>Great article! I'm really looking forward to the future of electric vehicles in Kenya.</p>
            </div>
        </div>
